package com.lolmains.configuration;
	  ...
	  @Autowired
	    ...
	    protected void configure(HttpSecurity http) throws Exception {
	        http
	            ...
	            .antMatchers("/knowledge/**", "/login").permitAll()
	            .antMatchers("/browse/**", "/login").permitAll()
	            .antMatchers("/", "/login").permitAll()
	            .antMatchers("//riot.txt", "/login").permitAll()
	            .antMatchers("/topic/**", "/login").permitAll()
	            .antMatchers("/newuser/**", "/login").permitAll()
	            .antMatchers("/videos/**", "/login").permitAll()
	            .antMatchers("/playstyle/**", "/login").permitAll()
